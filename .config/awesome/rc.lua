...
local redshift_widget = require("widgets.redshift")
...
-- awful.layout.termfair.nmaster = 2
...
-- {{{ Key bindings
local playerctl_cmd = "playerctl --player playerctld"
local globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioPlay", function()
        awful.util.spawn(playerctl_cmd .. " play-pause", false)
    end),
    awful.key({}, "XF86AudioNext", function()
        awful.util.spawn(playerctl_cmd .. " next", false)
    end),
    awful.key({}, "XF86AudioPrev", function()
        awful.util.spawn(playerctl_cmd .. " previous", false)
    end),
